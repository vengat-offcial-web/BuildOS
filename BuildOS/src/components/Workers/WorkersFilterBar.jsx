    ...
    <div className="glass-card p-4 rounded-[28px] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-3 text-xs">
        <span className="font-semibold text-slate-500">
          Showing <strong className="text-[#7C3AED] font-extrabold">{filteredCount}</strong> of {totalCount} workers
        </span>
      ...
      <div className="flex items-center gap-3 flex-wrap self-end sm:self-auto">
        ...
        >
          <option value="All">All Trades ({totalCount} Personnel)</option>
          {/* Note: Option items are dynamically rendered by caller */}
        </select>
      </div>
    </div>
  );
...
export default WorkersFilterBar;
